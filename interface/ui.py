...
class Ui_MainWindow(object):
    ...
    def loadImage(self):
        ...
        """
        try:
            faceCascade = cv2.CascadeClassifier('G:\My Drive\SpaceX\DataScience\DeepLearningForDS\Part 2 Computer Vision\Asm1\Mask-Detection\model\haarcascade_frontalface_default.xml')
    ...
    def plate_recognition(self):
        ...
        with open("plate2.jpg", 'rb') as img:
